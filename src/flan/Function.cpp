...
Graph Func1x1::convertToGraph( Rect view, Interval domain, Pixel width, Pixel height ) const
	{
...
void Func1x1::saveAsBMP( const std::string & filename, Rect view, Interval domain, Pixel width, Pixel height ) const
	{
	auto bmp = convertToGraph( view, domain, width, height );
...
// 	{
// 	return [periodCopy = period.copy()]( float t )
// 		{
// 		const float p = periodCopy( t );
