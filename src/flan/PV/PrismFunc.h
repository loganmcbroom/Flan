...
class PrismFunc {
public:
	using FuncType = std::function<MF ( Index note, Time, Index harmonic, Frequency contourFreq, const std::vector<Magnitude> & harmonicMagnitudes )>;
	...
	MF operator()( int n, Time t, int h, Frequency f, const std::vector<Magnitude> & hM ) const { return func(n, t, h, f, hM); }
