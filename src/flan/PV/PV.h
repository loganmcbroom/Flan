...
public:
	 ...
	 */
	static PV create_from_format( const PVBuffer::Format & other )
		{
		return PVBuffer( other );
		}

	/** Constructs a PV from the .flan file at filename.
	 *	\param filename A .flan filename to load. 
			This file type is flan specific and is generated by PVBuffer::save.
	 */
	static PV load_from_file( const std::string & filename ) 
		{
		return PVBuffer( filename );
		}
