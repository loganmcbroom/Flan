...
class Graph : public bitmap_image
	...
	public:
		 ...
		 * \param rect The plane space to graph within.
		 */
		void drawWaveforms( std::vector<Func1x1> fs, Rect rect = Rect(), int startPlane = 0, WaveformMode mode = WaveformMode::Direct, XCDP_CANCEL_ARG );
		 ...
		 * \param rect The plane space to graph within.
		 */
		void drawWaveforms( std::vector<const float *> datas, int n, Rect rect = Rect(), int startPlane = 0, WaveformMode mode = WaveformMode::Direct, XCDP_CANCEL_ARG );
		 ...
		 * \param rect The plane space to graph within.
		 */
		void drawSpectrograms( std::vector<Func2x1> fs, Rect rect = Rect(), int startPlane = 0, XCDP_CANCEL_ARG );
		 ...
		 * \param rect The plane space to graph within.
		 */
		void drawSpectrograms( std::vector<const float *> datas, int numFrames, int numBins, Rect rect = Rect(), int startPlane = 0, XCDP_CANCEL_ARG );
		 ...
		 */
		void drawFunction( const Func1x1 & f, Interval domain = Interval::R, int plane = -1, Color c = Color::Black, XCDP_CANCEL_ARG );
		 ...
		 */
		void drawFunction( const std::vector<std::pair<float,float>> & points, int plane = -1, Color c = Color::Black, XCDP_CANCEL_ARG );
		 ...
		 */
		void drawFunctions( const std::vector<Func1x1> & fs, std::vector<Interval> domains = {}, int plane = -1, XCDP_CANCEL_ARG );
