...
Audio Audio::invertPhase( XCDP_CANCEL_ARG_CPP ) const
	{
...
Audio Audio::modifyVolume( Func1x1 volumeLevel, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::setVolume( Func1x1 level, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::shift( Time shift, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::waveshape( Func1x1 shaper, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::pan( Func1x1 panAmount, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::widen( Func1x1 widenAmount, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_FUNCTION_LOG
	return convertToMidSide().pan( widenAmount, canceller ).convertToLeftRight( canceller );
	}

Audio Audio::reverse( XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::cut( Time startTime, Time endTime, Time startFade, Time endFade, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::cutFrames( Frame start, Frame end, Frame startFade, Frame endFade, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::repitch( Func1x1 factor, Time granulTime, uint32_t qual, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::convolve( const std::vector<Func1x1> & ir, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::convolve( const Audio & ir, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::fade( Time start, Time end, Interpolator interp, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::fadeFrames( Frame start, Frame end, Interpolator interp, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::lowPass( Func1x1 cutoff, uint32_t taps, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::grainSelect( Time length, Func1x1 grainsPerSecond, Func1x1 scatter, 
		Func1x1 selection, Func1x1 grainLength, Func1x1 fade, Mod mod, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
std::vector<Audio> Audio::chop( Time sliceLength, Time fade, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( std::vector<Audio>() );
...
Audio Audio::rearrange( Time sliceLength, Time fade, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::mix( const std::vector<Audio> & ins, std::vector<Func1x1> balances, 
	std::vector<Time> startTimes, XCDP_CANCEL_ARG_CPP )
	{
	XCDP_FUNCTION_LOG;
...
Audio Audio::join( const std::vector<Audio> & ins, float fade, XCDP_CANCEL_ARG_CPP )
	{
	XCDP_FUNCTION_LOG;
...
Audio Audio::select( const std::vector<Audio> & ins, Func1x1 selection, std::vector<Time> startTimes, XCDP_CANCEL_ARG_CPP )
	{
	XCDP_FUNCTION_LOG;
