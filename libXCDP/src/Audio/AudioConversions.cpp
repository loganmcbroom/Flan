...
Audio Audio::convertToMidSide( XCDP_CANCEL_ARG_CPP ) const
	{
...
Audio Audio::convertToLeftRight( XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_FUNCTION_LOG;
	return convertToMidSide( canceller );
	}

Audio Audio::convertToStereo( XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::convertToMono( XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( Audio() );
...
Audio Audio::saveToBMP( const std::string & filename, Interval I, int width, int height, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_FUNCTION_LOG;
...
PVOC Audio::convertToPVOC_cpu( Frame windowSize, Frame hopSize, Frame dftSize, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_FUNCTION_LOG;
...
PVOC Audio::convertToPVOC( Frame windowSize, Frame hopSize, Frame dftSize, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
	{
...
Func1x1 Audio::convertToFunction( Time granularity, XCDP_CANCEL_ARG_CPP ) const
	{
