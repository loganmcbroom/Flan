...
static std::vector<float> compute_d( const float * in, Frame n, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP )
	{
	...
	XCDP_CANCEL_POINT( std::vector<float>() );
...
static std::vector<float> compute_dPrime( const float * in, Frame n, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP )
	{
	// Get d
...
std::vector<float> Audio::getLocalWavelengths( Channel channel, Frame start, Frame end, Frame windowSize, Frame hop, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( std::vector<float>() );
...
float Audio::getAverageWavelength( Channel channel, float minActiveRatio, float maxLengthSigma, 
	Frame start, Frame end, Frame windowSize, Frame hop, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
	{
	XCDP_PROCESS_START( 0 );
...
Frequency Audio::getLocalFrequency( Channel channel, Frame start, Frame windowSize, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
	{
...
std::vector<Frequency> Audio::getLocalFrequencies( Channel channel, Frame start, Frame end, Frame windowSize, Frame hop, std::shared_ptr<FFTHelper> fft, XCDP_CANCEL_ARG_CPP ) const
    {
    XCDP_PROCESS_START( std::vector<Frequency>() );
